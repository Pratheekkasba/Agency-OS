...
export const WaitlistHero = () => {
    ...
    return (
      ...
      `}</style>
            ...
            {/* Main Container */}
            <div
                className="relative w-full h-[80vh] min-h-[600px] overflow-hidden rounded-3xl border border-zinc-800 shadow-2xl"
                style={{
            ...
            >
                    ...
                    <div className="absolute inset-0 animate-spin-slow">
                        ...
                        >
                            <img
                                ...
                                alt="Decoration"
                                className="w-full h-full object-cover opacity-20 object-center rounded-xl"
                            />
                        </div>
                    </div>
                </div>
                ...
                <div className="relative z-20 w-full h-full flex flex-col items-center justify-end pb-24 gap-6">
                    <div className="w-16 h-16 rounded-2xl shadow-lg ring-1 ring-white/10 overflow-hidden mb-2 relative">
                    ...
                    <p className="text-lg font-medium" style={{ color: colors.textSecondary }}>
                        Build, manage, and scale your agency seamlessly.
                    </p>
